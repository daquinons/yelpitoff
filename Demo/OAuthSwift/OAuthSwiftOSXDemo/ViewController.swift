...
class ViewController: NSViewController , NSTableViewDelegate, NSTableViewDataSource {
    ...
    @IBOutlet weak var searchBurgerPlaces: UIButton!
    ...
    func get_url_handler() -> OAuthSwiftURLHandlerType {
        ...
        @IBAction func searchForBurgerPlaces(sender: UIButton) {
        }
        // - in handle(url)
        ...
        @IBOutlet weak var getBurgerPlacesInSanFrancisco: UIButton!
